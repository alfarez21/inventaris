...
class PengembalianController extends Controller
{
    ...
    public function index()
    {
        $data['pinjam'] = DB::table('peminjaman')
                    ...
                    ->get();
        return view('KelolaPengembalian.daftar',$data);
    }
    ...
    public function tambah()
    {
        ...
        $data['aksi'] = "Tambah";
        return view('KelolaPengembalian.form',$data);
    }
    ...
    public function detail($id)
    {
        ...
        $data['detail_pinjam'] = DB::table('detail_pinjam')
                    ...
                    ->where("id_peminjaman",$id)
                    ->get();
        return view('KelolaPengembalian.detail',$data);
    }
    ...
    public function detailpinjam($id)
    {
        ...
        return view('KelolaPengembalian.detailPinjam',$data);
    }

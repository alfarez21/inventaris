                ...
                <div class="card-body">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($petugas->nama_level); ?></td>
                        </tr>
                    </table>
                </div>
                <!-- ./card-body -->
...
<?php echo $__env->make('dashboard.main',["alink"=> "petugas"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\lks\invetaris\resources\views/KelolaPetugas/detail.blade.php ENDPATH**/ ?>